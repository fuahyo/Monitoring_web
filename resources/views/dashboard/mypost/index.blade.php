                                ...
                                <td class="text-center">
                                    ...
                                    @if($reminder > $post->timeline)
                                        @if($currentdate <= $post->timeline)
                                          @if($post->prove == null && $post->modifikasi1 == null)
                                            <div>
                                              <a href="/dashboard/mypost/{{$post->slug}}/edit" class="btn btn-warning border-0 btn-sm mb-1 mr-1"><i class="fa fa-upload"></i><span data-feather="edit"></span> Justifikasi 1</a>
                                            </div>
                                          @endif
                                        @endif
                                    @endif
                                    @if($reminder > $post->timeline1)
                                        @if($currentdate <= $post->timeline1)
                                          @if($post->prove == null && $post->modifikasi2 == null)
                                            <div>
                                              <a href="/dashboard/mypost/{{$post->slug}}/edit" class="btn btn-warning border-0 btn-sm mb-1 mr-1"><i class="fa fa-upload"></i><span data-feather="edit"></span> Justifikasi 2</a>
                                            </div>
                                          @endif
                                        @endif
                                    @endif
                                    ...
                                    @else
                                      @if($currentdate <= $post->timeline)
                                        ...
                                        @endif
                                      @else
                                        @if(auth()->user()->role_id == '2' && $post->image != null)
                                          @if($post->approved == '0')
                                          <div>
                                            <a href="/dashboard/mypost/{{$post->slug}}/edit" class="btn btn-secondary border-0 btn-sm mb-1 mr-1"><i class="fa fa-thumbs-up"></i><span data-feather="edit"></span> Approve</a>
                                          </div>
